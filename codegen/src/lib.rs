...
///
/// ### Attributes
/// Structs have a few exclusive attributes that can be used to control the encoding/decoding of the struct. <br />
...
/// This attribute can be used on both named, and unnamed fields.
/// **Syntax:**
/// ```rust
/// #[skip]
/// ```
...
/// 
/// ## Enums
/// Enums function identically to structs, however they also 
